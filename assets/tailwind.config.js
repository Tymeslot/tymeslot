...
module.exports = {
  ...
  safelist: [
    ...
    "hero-video-camera",
    "hero-link",
    // Calendar integration colors (dynamically interpolated at runtime)
    "bg-calendar-1",
    "bg-calendar-2",
    "bg-calendar-3",
    "bg-calendar-4",
  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        calendar: {
          1: 'var(--color-calendar-1)',
          2: 'var(--color-calendar-2)',
          3: 'var(--color-calendar-3)',
          4: 'var(--color-calendar-4)',
          5: 'var(--color-calendar-5)',
          6: 'var(--color-calendar-6)',
          7: 'var(--color-calendar-7)',
          8: 'var(--color-calendar-8)',
          fallback: 'var(--color-calendar-fallback)',
        },
        tymeslot: {
          50: '#fafafa',
          100: '#f4f4f5',
