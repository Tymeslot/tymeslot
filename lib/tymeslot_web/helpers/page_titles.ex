defmodule TymeslotWeb.Helpers.PageTitles do
  ...
  def dashboard_title(:calendar), do: "Calendar - Dashboard"
  def dashboard_title(:calendar_integration), do: "Calendar Integration - Dashboard"
  def dashboard_title(:video_integration), do: "Video Integration - Dashboard"
