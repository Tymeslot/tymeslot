defmodule TymeslotWeb.Dashboard.CalendarGrid.EditWorkflow do
  ...
  # Move is a two-step operation: delete on source, then create on
  # destination. Each step can fail independently and the recovery
  # differs — case A (delete fails) leaves local state untouched and
  # the user can retry; case B (delete succeeds but create fails)
