    ...
    <div class={[
      ...
      <%= if @day_availability.is_available do %>
        ...
        <div class="mb-6 pb-6 border-b-2 border-tymeslot-50">
          <form
            id={"day-hours-form-#{@day_availability.day_of_week}"}
          ...
          <%= if @show_add_break_form == @day_availability.day_of_week do %>
            ...
            >
              ...
              <div class="flex gap-2">
                <button
                  type="submit"
                  class="btn-primary flex-1 py-3 flex items-center justify-center whitespace-nowrap"
                >
        ...
        <div class="flex flex-wrap items-center justify-between gap-4 mt-6 pt-6 border-t-2 border-tymeslot-50">
          <div class="flex flex-wrap gap-3">
            ...
            >
              <svg
                class="w-3.5 h-3.5 mr-2 text-tymeslot-400"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
