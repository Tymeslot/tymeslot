defmodule Tymeslot.Integrations.Calendar.Runtime.EventFetcherTest do
  ...
  describe "month_utc_boundaries/3" do
    test "UTC+12 produces start datetime before UTC month boundary" do
      ...
      {start_dt, _end_dt} = EventFetcher.month_utc_boundaries(2026, 3, "Pacific/Auckland")
    ...
    test "UTC-10 produces end datetime after UTC month boundary" do
      ...
      {_start_dt, end_dt} = EventFetcher.month_utc_boundaries(2026, 3, "Pacific/Honolulu")
    ...
    test "Etc/UTC produces same boundaries as naive Date approach" do
      {start_dt, end_dt} = EventFetcher.month_utc_boundaries(2026, 3, "Etc/UTC")
    ...
    test "invalid timezone raises" do
      assert_raise ArgumentError, fn ->
        EventFetcher.month_utc_boundaries(2026, 3, "Invalid/Timezone")
      end
    end
  end
end
