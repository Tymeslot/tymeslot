...
Mox.defmock(Tymeslot.Auth.UserBroadcasterMock,
  for: Tymeslot.Auth.Behaviours.UserBroadcaster
)

# Stripe internal mocks for testing the wrapper
# We use the behaviours defined in Tymeslot.Mocks.StripeBehaviours
